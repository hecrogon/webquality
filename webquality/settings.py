# Django settings for webquality project.
import os
import os.path
...
WSGI_APPLICATION = 'webquality.wsgi.application'
...
EMAIL_PORT = 25
EMAIL_HOST_USER = 'demotest@shidix.com'
EMAIL_HOST_PASSWORD = 'D3m0t3st'

SCRAPY_USER_AGENT = 'Mozilla/5.0 (X11; Linux x86_64; rv:25.0) Gecko/20100101 Firefox/25.0'
